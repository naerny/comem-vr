...
<template>
  ...
  simple-grab="allowMidAirDrop:true;">
    ...
    <template v-if="allAssetsLoaded">
      ...
      <a-entity light="type: spot; intensity: 1.3; distance: 5.2; penumbra: 0.6; color: #f4eea9; angle:60;"  position=".18 2.3 0.28" rotation="-90 0 0"></a-entity>
      <a-light id="light-music" color="red" position="0 2 0" intensity="0"></a-light>
      <a-entity light="type: spot; color: #DBAB1D; intensity: 3; angle:15; castshadow:true; penumbra:.8;" position=".25 4 .5" rotation="286.900 270 0"></a-entity>
      <a-entity light="type: spot; color: #DBAB1D; intensity: 3; angle:15; castshadow:true; penumbra:.8;" position="-.3 3.16 .5" rotation="286.900 90 0"></a-entity>
      <a-entity light="type: spot; color: #DBAB1D; intensity: 8; angle:25; castshadow:true; penumbra:1;" position="0 3.16 1.2" rotation="286.900 180 0"></a-entity>

      <a-ocean color="#d600ff" position="0 -.5 0" width="100" depth="100" amplitude="0.2" density="100" amplitudeVariance="0.1"></a-ocean>
      <a-ocean color="#00b8ff" position="0 -.5 0" width="100" depth="100" amplitude="0.05" density="100" amplitudeVariance="0.1"></a-ocean> 
      ...
      <a-entity position="0 .01 1.5" rotation="-90 180 0" >
        ...
        <a-plane  color="#e2e8f0" height="1" width="1.5" ></a-plane>
    </a-entity>
